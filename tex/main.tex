...
\bibitem{openmeteo}
Zippenfenig, P. (2023). \textit{Open-Meteo: High-resolution weather API for developers}. Available at: \url{https://open-meteo.com/} Access date: 22.01.2026.

\bibitem{regression}
Montgomery, D. C., Peck, E. A., \& Vining, G. G. (2021). \textit{Introduction to Linear Regression Analysis}. Wiley Series in Probability and Statistics, 12-22.
